...
public class JakMain {
	...
	public static void main(String[] args) throws Exception {
		...
		//Deserialisation de factory

		try
		{
			FileInputStream fileIn = new FileInputStream("Factory.ser");
			ObjectInputStream in = new ObjectInputStream(fileIn);
			f = (AgentFactory) in.readObject();
			in.close();
			fileIn.close();
		}catch(IOException i)
		{
		...
		{
			System.out.println("Factory class not found");
			c.printStackTrace();
			return;
		}

		System.out.println("Deserialized Factory...");
		compteur=f.CompteurStudent;
